...
import { MenuItem, TextField, Grid, Typography, FormControlLabel, FormGroup, Checkbox } from '@mui/material';
...
export default function Index() {
  ...
  return (
    <Fragment>
      <Container maxWidth="lg" sx={{ position: "absolote", height: "10vh", background: "lightgrey" }}>
      ...
      <Container maxWidth="lg" >
        ...
        <Box sx={{ mx: 1, mt: 1, p: 2, border: "2px dashed grey", borderTop: "none", height: "80vh", overflow: "hidden" }}>
          <Grid container spacing={1}>
            <Grid item xs = {12} sm = {3}>
                <TextField 
                select value={ctx.state.jud} onChange={judChangeHandler} fullWidth
                label="JUDETUL"
              >
                {JUDETE.map((e, i) => (
            ...
            <Grid item xs = {12} sm = {3}>
                <TextField
                select value={ctx.state.loc} onChange={locChangeHandler} fullWidth
            ...
            <Grid item sm = {12}>
              <Typography variant = "subtitle1" align="center" fontWeight={900}>
            DECLARAȚIE DE ÎNREGISTRARE <br/>
în Registrul de evidență a sistemelor individuale adecvate pentru colectarea apelor uzate 
<br/> din localitatea {' '}
...
județul {ctx.state.jud ? SIRUTA.find( el => el.siruta === ctx.state.jud)['denloc']  : "---"}
            ...
            <Grid item sm = {12}>
                <Box sx = {{background: "none", p:1, height: "55vh", overflow: "auto"}}>
                    ...
                    <Grid container>
                      ...
                      <Grid item sm = {12}>
                        ...
                        <br/>
                          <TextField variant="filled" fullWidth sx = {{px:2}}/>
                      </Grid>
                    ...
                    <Grid item sm = {12}>
                      ...
                      <Grid item sm = {12}>
                        ...
                        <FormControlLabel 
                              ...
                              control = {<Checkbox/>}
                          />  
                          <TextField size="small" label = "capacitate"/>
                          <br/>
                          <FormControlLabel 
                              label = "Epurare"
                              control = {<Checkbox/>}
                      ...
                      <Grid item sm = {12}>
                        <Typography variant = "subtitle2" fontWeight={800}>
                          ...
                          <TextField multiline rows={2} variant="filled" fullWidth sx = {{px:2}}/>
                      </Grid>
                        ...
                        <br/><br/>
                          <Grid container spacing={2}>
                            <Grid item xs = {12} sm = {2}>
                              <TextField variant="filled" fullWidth label = "CONTRACT NR."/>
                            </Grid>
